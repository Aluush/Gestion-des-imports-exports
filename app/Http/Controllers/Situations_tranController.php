...
class Situations_tranController extends Controller
{
    /**
    ...
    public function show()
    {
        ...
        $dums = DB::table('situations_trans')
            ->where('operateur_id', $user->id)
            ->get();
    
        return view('trans-situation', compact('dums'));  
    }
    ...
    public function trier(Request $request)
    {
        ...
        if ($request->has('cherche')) {
            ...
            return view('trans-situation')->with('dums', $dums);;
